...
<head>
    ...
    <title>{{ __('messages.login_title') }} - FST ePub</title>
    <script src="https://cdn.tailwindcss.com"></script>
    <script>
        tailwind.config = { darkMode: 'class' }
    </script>
    <script>
        // Cek localStorage tema
    ...
    <div class="min-h-screen flex">
        ...
        <div class="hidden lg:block relative w-0 flex-1">
            ...
            <div class="absolute bottom-0 left-0 p-10 text-white">
                <h2 class="text-4xl font-bold">Fakultas Sains & Teknologi</h2>
                <p class="mt-2 text-lg text-gray-200">{{ __('messages.fst_slogan') }}</p>
            </div>
        </div>
            ...
            <div class="mx-auto w-full max-w-sm lg:w-96">
                <div>
                    ...
                    <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                        ...
                        <a href="{{ route('register') }}" class="font-medium text-green-600 hover:text-green-500 dark:text-green-500 transition-colors">
                            {{ __('messages.register_link') }}
                        </a>
                    </p>
                </div>
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <input id="email" name="email" type="email" required 
                                    class="appearance-none block w-full px-3 py-3 border border-gray-300 dark:border-gray-700 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-green-500 focus:border-green-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-white sm:text-sm transition-colors">
                            </div>
                        </div>

...
<head>
    ...
    <script>
        // Gunakan key 'color-theme' agar sinkron dengan Landing Page
        ...
        function toggleTheme() {
            if (document.documentElement.classList.contains('dark')) {
                document.documentElement.classList.remove('dark');
                localStorage.setItem('color-theme', 'light'); // Simpan ke 'color-theme'
            } else {
                document.documentElement.classList.add('dark');
                localStorage.setItem('color-theme', 'dark'); // Simpan ke 'color-theme'
            }
        }
    </script>
</head>
